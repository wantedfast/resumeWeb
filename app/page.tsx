        ...
        <div className={`experience-stage mode-${heroMode}`}>
          {heroMode === "agent" ? (
            <div className="agent-view">
              ...
              >
                <span className="orb-shell"><Mic2 strokeWidth={1.35} /></span>
      ...
      <section className="about-section" id="about">
        ...
        <div className="contact-panel">
          ...
          <div className="contact-actions">
            ...
            <button type="button" disabled><Mail size={18} />{t.emailPending}</button>
            <button type="button" disabled><FileDown size={18} />{t.resumePending}</button>
          </div>
        </div>
        <footer>
